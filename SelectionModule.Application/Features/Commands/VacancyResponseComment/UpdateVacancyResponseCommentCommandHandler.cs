...
public class UpdateVacancyResponseCommentCommandHandler : IRequestHandler<UpdateVacancyResponseCommentCommand, Unit>
{
    ...
    public UpdateVacancyResponseCommentCommandHandler(IVacancyResponseRepository vacancyResponseRepository, IVacancyResponseCommentRepository vacancyResponseCommentRepository)
    {
        _vacancyResponseRepository = vacancyResponseRepository;
        _vacancyResponseCommentRepository = vacancyResponseCommentRepository;
    }

    public async Task<Unit> Handle(UpdateVacancyResponseCommentCommand request, CancellationToken cancellationToken)
    {
        ...
        await _vacancyResponseCommentRepository.UpdateAsync(comment);
