...
{
    public class AddUserRoleCommandHandler : IRequestHandler<AddUserRoleCommand, User>
    {
        private readonly IUserRepository _userRepository;
        private readonly IRoleRepository _roleRepository;
        public AddUserRoleCommandHandler(IUserRepository userRepository, IRoleRepository roleRepository)
        {
            _userRepository = userRepository;
            _roleRepository = roleRepository;
        }

        public async Task<User> Handle(AddUserRoleCommand command, CancellationToken cancellationToken)
        {
            ...
            else throw new Conflict("User already has this role");
